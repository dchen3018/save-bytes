...
const save_and_load = () => __awaiter(void 0, void 0, void 0, function* () {
    const new_account = anchor.web3.Keypair.generate();
    console.log('pubkey ', new_account.publicKey.toString());
    fs_1.default.writeFileSync('./account.json', JSON.stringify(new_account));
    const account_file_string = fs_1.default.readFileSync('../account.json', 'utf-8');
